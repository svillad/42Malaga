...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/22 15:45:42 by svilla-d          #+#    #+#             */
/*   Updated: 2025/02/22 15:45:43 by svilla-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    try {
        ...
        std::cout << "\n---------- Intern's tests ----------" << std::endl;
        Intern intern;
        intern.setLogger(logger);
        AForm *f4 = NULL;

        f4 = intern.makeForm("ShrubberyCreationForm", "home");
        std::cout << *f4 << std::endl;
        b1.signForm(*f4);
        b1.executeForm(*f4);
        delete f4;
        std::cout << std::endl;
        f4 = intern.makeForm("RobotomyRequestForm", "Bender");
        std::cout << *f4 << std::endl;
        b1.signForm(*f4);
        b1.executeForm(*f4);
        delete f4;
        std::cout << std::endl;
        f4 = intern.makeForm("PresidentialPardonForm", "Ford Prefect");
        std::cout << *f4 << std::endl;
        b1.signForm(*f4);
        b1.executeForm(*f4);
        delete f4;
