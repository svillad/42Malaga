...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/08 13:28:18 by svilla-d          #+#    #+#             */
/*   Updated: 2024/11/08 13:28:19 by svilla-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Animal::Animal(const Animal &a) {
  std::cout << "\e[34m[Animal]\e[0m Copy constructor called for " << a.type << std::endl;
  *this = a;
}
